...
protocol GiftRecordRepositoryProtocol {
    ...
    func create(amount: Double, direction: String, recordType: String, eventName: String, eventCategory: String, eventDate: Date, note: String, contactName: String, source: String, itemName: String, estimatedAmount: Double, includeInGiftStats: Bool, isLoanSettled: Bool, loanDueDate: Date, book: GiftBook?, contact: Contact?, context: ModelContext) throws -> GiftRecord
